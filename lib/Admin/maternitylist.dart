...
class MaternityList extends StatefulWidget {
  @override
  MaternityListState createState() => MaternityListState();
}

class MaternityListState extends State<MaternityList> {
  @override
  List maternitylist = [];
  ...
  fetchUser() async {
    ...
    var url = "http://hospitalmanagement.educationhost.cloud/maternitylist.php";
  ...
  Widget listBody() {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return maternitycard(maternitylist[index]);
        });
  }
