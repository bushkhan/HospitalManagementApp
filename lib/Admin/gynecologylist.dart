...
class GynecologyList extends StatefulWidget {
  @override
  GynecologyListState createState() => GynecologyListState();
}

class GynecologyListState extends State<GynecologyList> {
  @override
  List gynecologylist = [];
  ...
  Widget listBody() {
    if (gynecologylist.contains(null) ||
        gynecologylist.length < 0 ||
        isLoading) {
      return Center(
    ...
    return ListView.builder(
        itemCount: gynecologylist.length,
        shrinkWrap: true,
        itemBuilder: (context, index) {
          return gynecologycard(gynecologylist[index]);
        });
  }

  Widget gynecologycard(items) {
    var name = items['name'];
