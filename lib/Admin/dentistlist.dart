...
class DentistList extends StatefulWidget {
  @override
  DentistListState createState() => DentistListState();
}

class DentistListState extends State<DentistList> {
  @override
  List dentistlist = [];
  ...
  Widget listBody() {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return dentistcard(dentistlist[index]);
        });
  }
