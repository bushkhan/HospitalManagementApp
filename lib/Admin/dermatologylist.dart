...
class DermatologyList extends StatefulWidget {
  @override
  DermatologyListState createState() => DermatologyListState();
}

class DermatologyListState extends State<DermatologyList> {
  @override
  List dermalist = [];
  ...
  Widget listBody() {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return dermacard(dermalist[index]);
        });
  }
