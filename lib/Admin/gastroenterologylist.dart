...
class GastroenterologyList extends StatefulWidget {
  @override
  GastroenterologyListState createState() => GastroenterologyListState();
}

class GastroenterologyListState extends State<GastroenterologyList> {
  @override
  List gastrolist = [];
  ...
  Widget listBody() {
    if (gastrolist.contains(null) || gastrolist.length < 0 || isLoading) {
      return Center(
    ...
    return ListView.builder(
        itemCount: gastrolist.length,
        shrinkWrap: true,
        itemBuilder: (context, index) {
          return gastrocard(gastrolist[index]);
        });
  }

  Widget gastrocard(items) {
    var name = items['name'];
