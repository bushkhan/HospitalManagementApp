...
class CardiologyList extends StatefulWidget {
  @override
  CardiologyListState createState() => CardiologyListState();
}

class CardiologyListState extends State<CardiologyList> {
  @override
  List cardiolist = [];
  ...
  Widget listBody() {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return CardioCard(items: cardiolist[index]);
        });
  }
}
...
class CardioCard extends StatelessWidget {
  ...
  const CardioCard({Key key, this.items}) : super(key: key);
  Widget build(BuildContext context) {
    var name = items['name'];
    ...
    return Container(
      margin: EdgeInsets.only(left: 9.0, right: 6.0, top: 10.0, bottom: 10),
