...
class HematologyList extends StatefulWidget {
  @override
  HematologyListState createState() => HematologyListState();
}

class HematologyListState extends State<HematologyList> {
  @override
  List hematologylist = [];
  ...
  Widget listBody() {
    if (hematologylist.contains(null) ||
        hematologylist.length < 0 ||
        isLoading) {
      return Center(
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return hematologycard(hematologylist[index]);
        });
  }

  Widget hematologycard(items) {
    var name = items['name'];
