...
class OpthalmologyList extends StatefulWidget {
  @override
  OpthalmologyListState createState() => OpthalmologyListState();
}

class OpthalmologyListState extends State<OpthalmologyList> {
  @override
  List ophthallist = [];
  ...
  Widget listBody() {
    if (ophthallist.contains(null) || ophthallist.length < 0 || isLoading) {
      return Center(
    ...
    return ListView.builder(
        itemCount: ophthallist.length,
        shrinkWrap: true,
        itemBuilder: (context, index) {
          return ophthalcard(ophthallist[index]);
        });
  }

  Widget ophthalcard(items) {
    var name = items['name'];
